...
public class ZcApplet extends JBaseApplet {
  ...
  private void initWorkEnv() {
    /* WorkEnv workEnv = WorkEnv.getInstance();
     ...
     if (logger.isDebugEnabled()) {
       logger.debug("workEnv:: user: " + workEnv.getCurrUser().getUserId() + " " + workEnv.getCurrUser().getUserName() + " " + workEnv.getCurrCompany() + " transDate:" + workEnv.getTransDate()
         + " expertName:" + workEnv.getExpertName() + workEnv.getTransDate() + " empCode:" + workEnv.getEmpCode());
     }*/
  }
  ...
  private void initAppletParameters() {
    ...
    if (logger.isDebugEnabled()) {
      logger.debug("panelClassName: " + panelClassName + " token:" + token + " clientIP:" + clientIP + " userId:" + userId + " cocode:" + coCode + " orgCode:" + orgCode + " orgPocode: " + orgPoCode
        + " poCode:" + poCode + " webRoot:" + webRoot + " transDate: " + transDate + " accountId:" + expertCode + " : " + expertCode + " expertName:" + expertName + "empCode:" + empCode + "empName:"
        + empName);
    }

    System.out.println("panelClassName: " + panelClassName + " token:" + token + " clientIP:" + clientIP + " userId:" + userId + " cocode:" + coCode + " orgCode:" + orgCode + " orgPocode: "
      + orgPoCode + " poCode:" + poCode + " webRoot:" + webRoot + " webIp:" + webIp + " transDate: " + transDate + " accountId:" + expertCode + " : " + expertCode + " expertName:" + expertName
  ...
  public boolean equals(Object obj) {
    ...
    if (appletWindow == null) {
      if (other.appletWindow != null) return false;
    } else if (!appletWindow.equals(other.appletWindow)) return false;
    if (clientIP == null) {
      if (other.clientIP != null) return false;
    } else if (!clientIP.equals(other.clientIP)) return false;
    if (coCode == null) {
      if (other.coCode != null) return false;
    } else if (!coCode.equals(other.coCode)) return false;
    if (orgCode == null) {
      if (other.orgCode != null) return false;
    } else if (!orgCode.equals(other.orgCode)) return false;
    if (orgPoCode == null) {
      if (other.orgPoCode != null) return false;
    } else if (!orgPoCode.equals(other.orgPoCode)) return false;
    if (panelClassName == null) {
      if (other.panelClassName != null) return false;
    } else if (!panelClassName.equals(other.panelClassName)) return false;
    if (poCode == null) {
      if (other.poCode != null) return false;
    } else if (!poCode.equals(other.poCode)) return false;
    if (token == null) {
      if (other.token != null) return false;
    } else if (!token.equals(other.token)) return false;
    if (transDate == null) {
      if (other.transDate != null) return false;
    } else if (!transDate.equals(other.transDate)) return false;
    if (userId == null) {
      if (other.userId != null) return false;
    } else if (!userId.equals(other.userId)) return false;
    if (webRoot == null) {
      if (other.webRoot != null) return false;
    } else if (!webRoot.equals(other.webRoot)) return false;
    if (webIp == null) {
      if (other.webIp != null) return false;
    } else if (!webIp.equals(other.webIp)) return false;
    if (expertCode == null) {
      if (other.expertCode != null) return false;
    } else if (!expertCode.equals(other.expertCode)) return false;
    if (expertName == null) {
      if (other.expertName != null) return false;
    } else if (!expertName.equals(other.expertName)) return false;
    if (empCode == null) {
      if (other.empCode != null) return false;
    } else if (!empCode.equals(other.empCode)) return false;
    if (empName == null) {
      if (other.empName != null) return false;
    } else if (!empName.equals(other.empName)) return false;
    return true;
  }
