 ...
 */
public class JzxtpZhaobiaoBulletinHandler implements ITemplateToDocumentHandler {

  String templateFileId = "bulletin_zhaobiao_jzxtp";
  ...
  private void getxunjia(Map<String, Object> dataMap, ZcEbBulletin bulletin) {
    ...
    d = bulletin.getZcEbPlan().getSellEndTime() == null ? bulletin.getZcEbPlan().getBidEndTime() : bulletin.getZcEbPlan().getSellEndTime();
