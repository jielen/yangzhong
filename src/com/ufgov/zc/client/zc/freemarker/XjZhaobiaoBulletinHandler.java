...
public class XjZhaobiaoBulletinHandler implements ITemplateToDocumentHandler {
  ...
  private void getxunjia(Map<String, Object> dataMap, ZcEbBulletin bulletin) {
    ...
    BigDecimal sum = bulletin.getZcEbProj().getProjSum();
    double sumd = sum == null ? 0 : sum.doubleValue();
    String sumStr = String.format("%.2f", sumd);
    dataMap.put("projSum", StringUtil.freeMarkFillWordChar(sumStr));
