...
public class ZcEbZxjjListPanel  extends AbstractEditListBill implements ParentWindowAware {
  /**
   * 
   */

  public static final Logger logger = Logger.getLogger(ZcEbZxjjListPanel.class);

  private ZcEbZxjjListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "ZC_EB_ZXJJ";

  private RequestMeta requestMeta = WorkEnv.getInstance().getRequestMeta();

  private ElementConditionDto elementConditionDto = new ElementConditionDto();

  private IZcEbZxjjServiceDelegate zcEbZxjjServiceDelegate;
  ...
  public ZcEbZxjjListPanel() {
    init();
  }
 

  public void init() {
    zcEbZxjjServiceDelegate = (IZcEbZxjjServiceDelegate) ServiceFactory.create(IZcEbZxjjServiceDelegate.class, "zcEbZxjjServiceDelegate");
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(ZcEbZxjj.TAB_ID), showingDisplays,
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(ZcEbZxjj.SEARCH_ID, null, true, defaultValueMap, null);
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, ZcEbZxjj.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              ZcEbZxjj charge = (ZcEbZxjj) viewList.get(row); 
              
                new ZcEbZxjjDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return ZcEbZxjjToTableModelConverter.convertMainLst(self.zcEbZxjjServiceDelegate.getMainDataLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcEbZxjjListPanel bill = new ZcEbZxjjListPanel();
...
//    toolBar.add(addButton);
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(ZcEbZxjjToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<ZcEbZxjj> beanList = new ArrayList<ZcEbZxjj>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      ZcEbZxjj bean = (ZcEbZxjj) list.get(accordDataRow);
...
//    new ZcEbZxjjDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      ZcEbZxjj bean = (ZcEbZxjj) beanList.get(i);
