...
import com.ufgov.zc.client.common.converter.zc.ZcPasswordTableModelConverter;
 ...
 */
public class ZcPasswordListPanel extends AbstractEditListBill implements ParentWindowAware {

  public static final Logger logger = Logger.getLogger(ZcPasswordListPanel.class);

  private ZcPasswordListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "ZC_PASSWORD";
  ...
  public ZcPasswordListPanel() {
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        List<SearchCondition> needDisplaySearchConditonList = SearchConditionUtil.getNeedDisplaySearchConditonList(WorkEnv.getInstance().getCurrUserId(), "ZC_PASSWORD_Tab");
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay("ZC_PASSWORD_Tab"), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, "ZC_PASSWORD_Tab");
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new ZcPasswordDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          if (tableDisplay.getStatus().equals("ysdw")) {//采购单位用户
            return ZcPasswordTableModelConverter.convertToTableModel(self.zcEbBaseServiceDelegate.queryDataForList("User.getCoUser", elementConditionDto, requestMeta));
          } else if (tableDisplay.getStatus().equals("gys")) {//供应商
            return ZcPasswordTableModelConverter.convertToTableModel(self.zcEbBaseServiceDelegate.queryDataForList("User.getGysUser", elementConditionDto, requestMeta));
          } else if (tableDisplay.getStatus().equals("qt")) {//其他 目前只指公共资源交易中心
            return ZcPasswordTableModelConverter.convertToTableModel(self.zcEbBaseServiceDelegate.queryDataForList("User.getJyzxUser", elementConditionDto, requestMeta));
          }
          return ZcPasswordTableModelConverter.convertToTableModel(new ArrayList());
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcPasswordListPanel bill = new ZcPasswordListPanel();
  ...
  private void doAdd() {
    ...
    new ZcPasswordDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
