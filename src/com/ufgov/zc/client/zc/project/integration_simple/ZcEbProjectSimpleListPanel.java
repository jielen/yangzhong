...
/**
 * @ClassName: ZcEbProjectSimpleListPanel
 * @Description: 项目立项,使用wordpanel，黏贴已经做好的招标文件来实现的
...
public class ZcEbProjectSimpleListPanel extends AbstractEditListBill implements ParentWindowAware {
  private static final Logger logger = Logger.getLogger(ZcEbProjectSimpleListPanel.class);
  ...
  protected IBaseDataServiceDelegate baseDataServiceDelegate = (IBaseDataServiceDelegate) ServiceFactory.create(IBaseDataServiceDelegate.class, "baseDataServiceDelegate");
  ...
  private BillElementMeta detailPackBillElementMeta = BillElementMeta.getBillElementMetaWithoutNd(ZcEbProjectSimpleListPanel.compoId + "_PACK");

  public BillElementMeta getDetailPackBillElementMeta() {
    return detailPackBillElementMeta;
  }

  private BillElementMeta detailPackReqBillElementMeta = BillElementMeta.getBillElementMetaWithoutNd(ZcEbProjectSimpleListPanel.compoId + "_PACKREQ");
  ...
  public IZcEbBaseServiceDelegate zcEbBaseServiceDelegate = (IZcEbBaseServiceDelegate) ServiceFactory.create(IZcEbBaseServiceDelegate.class, "zcEbBaseServiceDelegate");
  ...
  private final class DataDisplay extends MultiDataDisplay {
    private DataDisplay(List<TableDisplay> displays, List<TableDisplay> showingDisplays, AbstractSearchConditionArea conditionArea, boolean showConditionArea) {
      ...
      setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), LangTransMeta.translate("ZC_EB_PROJ_TITLE"), TitledBorder.CENTER, TitledBorder.TOP, new Font("宋体", Font.BOLD, 15),
        Color.BLUE));
    }
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new ZcEbProjectSimpleDialog(ZcEbProjectSimpleListPanel.this, viewList, row, tabStatus);
            }
          }
        });
      }
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return ZcEbProjectToTableModelConverter.convertToTableModel(ZcEbProjectSimpleListPanel.this.zcEbProjectServiceDelegate.getZcEbProj(elementConditionDto, requestMeta));
        }
   ...
   * 构造函数
   */
  public ZcEbProjectSimpleListPanel() {
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      @Override
      public List<SearchCondition> execute() throws Exception {
        List<SearchCondition> needDisplaySearchConditonList = SearchConditionUtil.getNeedDisplaySearchConditonList(WorkEnv.getInstance().getCurrUserId(), "ZcEbProj_ProjTab");
  ...
  private void doAdd() {
    new ZcEbProjectSimpleDialog(ZcEbProjectSimpleListPanel.this, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  }
  ...
  private boolean toCheckZbFileAndEvalElements(ZcEbProj zcEbProj) {
    if (ZcSettingConstants.PITEM_OPIWAY_XJ.equals(zcEbProj.getPurType())) { return false; }
  ...
  public static void main(String[] args) throws Exception {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        ...
        ZcEbProjectSimpleListPanel bill = new ZcEbProjectSimpleListPanel();
