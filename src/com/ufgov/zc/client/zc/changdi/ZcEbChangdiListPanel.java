...
import com.ufgov.zc.client.common.converter.zc.ZcEbChangdiToTableModelConverter;
 ...
 *
 */
public class ZcEbChangdiListPanel  extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(ZcEbChangdiListPanel.class);

  private ZcEbChangdiListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "ZC_EB_CHANGDI";
  ...
  public ZcEbChangdiListPanel() {
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        .getCurrUserId(), ZcEbChangdi.TAB_ID);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(ZcEbChangdi.TAB_ID), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, ZcEbChangdi.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new ZcEbChangdiDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return ZcEbChangdiToTableModelConverter.convertMainLst(self.zcEbChangdiServiceDelegate.getMainDataLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcEbChangdiListPanel bill = new ZcEbChangdiListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(ZcEbChangdiToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<ZcEbChangdi> beanList = new ArrayList<ZcEbChangdi>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      ZcEbChangdi bean = (ZcEbChangdi) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new ZcEbChangdiDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      ZcEbChangdi bean = (ZcEbChangdi) beanList.get(i);
