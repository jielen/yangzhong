 ...
 * 
 */
package com.ufgov.zc.client.zc.bulletin.feibiao;
 ...
 */
public class ZcEbBulletinFeiBiaoListPanel extends AbstractEditListBill implements ParentWindowAware {

  private String compoId = "ZC_EB_BULLETIN_FEIBIAO";

  private static final Logger logger = Logger.getLogger(AbstractZcEbBulletinBaseListPanel.class);

  private final ZcEbBulletinFeiBiaoListPanel self = this;

  private Window parentWindow;

  protected String title = LangTransMeta.translate(compoId);

  protected String bulletinTab = "ZcEbBulletin_bulletinFeiBiaoTab";

  protected String bulletinCondition = "ZcEbBulletin_bulletinFeiBiaoTab";
  ...
  public ZcEbBulletinFeiBiaoListPanel() {
    init();
  }
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new ZcEbBulletinFeiBiaoDialog(self, beanList, row, tabStatus);
            }
  ...
  protected void doAdd() {
    ...
    new ZcEbBulletinFeiBiaoDialog(self, new ArrayList(), this.topDataDisplay.getActiveTableDisplay().getTable().getRowCount(), topDataDisplay.getActiveTableDisplay().getStatus());
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcEbBulletinFeiBiaoListPanel bill = new ZcEbBulletinFeiBiaoListPanel();
