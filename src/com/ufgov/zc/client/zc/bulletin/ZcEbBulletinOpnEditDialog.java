...
public class ZcEbBulletinOpnEditDialog extends GkBaseDialog {

	private static final Logger logger = Logger
			.getLogger(ZcEbBulletinOpnEditDialog.class);

	private static final long serialVersionUID = 1L;

	private ZcEbBulletinOpnEditDialog self = this;

	private ZcEbBulletinOpnEditPanel editPanel;

	public ZcEbBulletinOpnEditDialog(ZcEbBulletinOpnListPanel listPanel,
			List beanList, int editingRow, String tabStatus) {

		super(listPanel.getParentWindow(),
				Dialog.ModalityType.APPLICATION_MODAL);

		editPanel = new ZcEbBulletinOpnEditPanel(this.self, new ListCursor(
