...
public class ZcEbBulletinZGYSListPanel extends AbstractZcEbBulletinBaseListPanel {
  ...
  private static final Logger logger = Logger.getLogger(ZcEbBulletinZGYSListPanel.class);

  private ZcEbBulletinZGYSListPanel self = this;

  public ZcEbBulletinZGYSListPanel() {

    super();

    this.setTitle(ZcEbBulletinConstants.TITLE_ZC_EB_BULLETIN_ZGYS);

    this.setCompoID(ZcEbBulletinConstants.COMPO_ZC_EB_BULLETIN_ZGYS);
  ...
  protected void openDialog(Window parentWindow, List viewList, int row, String tabStatus) {
    ...
    new ZcEbBulletinZGYSEditDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());

  }

  protected void doAdd() {

    new ZcEbBulletinZGYSEditDialog(self, new ArrayList(), this.topDataDisplay.getActiveTableDisplay().getTable().getRowCount(), topDataDisplay
  ...
  public void doTraceDataButton() {
    ...
    DataFlowConsoleCanvas dfc = new DataFlowConsoleCanvas(sh.getProjCode(), ZcEbBulletinConstants.COMPO_ZC_EB_BULLETIN_ZGYS);
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcEbBulletinZGYSListPanel bill = new ZcEbBulletinZGYSListPanel();
