...
public class ZcEbBulletinCJListPanel extends AbstractZcEbBulletinBaseListPanel {
  ...
  private static final Logger logger = Logger.getLogger(ZcEbBulletinCJListPanel.class);

  private ZcEbBulletinCJListPanel self = this;

  public ZcEbBulletinCJListPanel() {

    super();

    this.setTitle(ZcEbBulletinConstants.TITLE_ZC_EB_BULLETIN_CJ);

    this.setCompoID(ZcEbBulletinConstants.COMPO_ZC_EB_BULLETIN_CJ);
  ...
  protected void openDialog(Window parentWindow, List viewList, int row, String tabStatus) {
    ...
    new ZcEbBulletinCJEditDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());

  }

  protected void doAdd() {

    new ZcEbBulletinCJEditDialog(self, new ArrayList(), this.topDataDisplay.getActiveTableDisplay().getTable().getRowCount(), topDataDisplay
  ...
  public void doTraceDataButton() {
    ...
    DataFlowConsoleCanvas dfc = new DataFlowConsoleCanvas(sh.getProjCode(), ZcEbBulletinConstants.COMPO_ZC_EB_BULLETIN_CJ);
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcEbBulletinCJListPanel bill = new ZcEbBulletinCJListPanel();
