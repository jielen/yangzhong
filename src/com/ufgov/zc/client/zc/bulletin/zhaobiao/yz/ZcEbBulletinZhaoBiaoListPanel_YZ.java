...
public class ZcEbBulletinZhaoBiaoListPanel_YZ  extends AbstractEditListBill implements ParentWindowAware {
  ...
  private final ZcEbBulletinZhaoBiaoListPanel_YZ self = this;
  ...
  public ZcEbBulletinZhaoBiaoListPanel_YZ() {
    init();
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        ZcEbBulletinZhaoBiaoListPanel_YZ bill = new ZcEbBulletinZhaoBiaoListPanel_YZ();
