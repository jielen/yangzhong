...
public class ZcEbAgencyAptToTableModelConverter {
  ...
  public static DefaultTableModel convertToTableModel(List agencyList) {
    ...
    if (agencyList != null && agencyList.size() > 0) {
      for (int i = 0; i < agencyList.size(); i++) {
        ...
        ZcBAgencyListAptd zcBAgencyApt = (ZcBAgencyListAptd) agencyList.get(i);
        rowData.add(zcBAgencyApt.getZcAptdCode());
        rowData.add(zcBAgencyApt.getZcAptdName());
        values.add(rowData);
      }
    }
