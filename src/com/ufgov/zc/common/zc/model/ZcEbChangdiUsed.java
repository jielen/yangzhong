...
public class ZcEbChangdiUsed extends ZcBaseBill {
  ...
  public static final String COL_ENDDATE = "ZC_EB_CHANGDI_USED_ENDDATE"; // 开标结束时间
  ...
  public static final String COL_STARTDATE = "ZC_EB_CHANGDI_USED_STARTDATE"; // 开标开始时间
  ...
  public static final String COL_PINGBIAODATE = "ZC_EB_CHANGDI_USED_PINGBIAODATE"; // 评标开始时间

  public static final String COL_PINGBIAOENDDATE = "ZC_EB_CHANGDI_USED_PINGBIAOENDDATE"; // 评标结束时间
   ...
   * 评标场地
   */
  private ZcEbChangdi changdi2 = new ZcEbChangdi();
  ...
  private Date pingbiaodate;

  private Date pingbiaoenddate;

  private String changdiguid2;

  private String changdiname2;
  ...
  public Date getPingbiaoenddate() {
    return pingbiaoenddate;
  }

  public void setPingbiaoenddate(Date pingbiaoenddate) {
    this.pingbiaoenddate = pingbiaoenddate;
  }

  public String getChangdiguid2() {
    return changdiguid2;
  }

  public void setChangdiguid2(String changdiguid2) {
    this.changdiguid2 = changdiguid2;
  }

  public String getChangdiname2() {
    return changdiname2;
  }

  public void setChangdiname2(String changdiname2) {
    this.changdiname2 = changdiname2;
  }
  ...
  public void setStartdate(Date startdate) {
    ...
    if (startdate == null) {
      setEnddate(null);
      setPingbiaodate(null);
    } else {
      GregorianCalendar gc = new GregorianCalendar();
      //设置评标开始时间，默认半小时后开始
      gc.setTime(startdate);
      gc.add(Calendar.MINUTE, 30);
      setPingbiaodate(gc.getTime());
      //设置结束时间,默认一小时结束
      gc.setTime(startdate);
      gc.add(Calendar.HOUR_OF_DAY, 1);
      setEnddate(gc.getTime());
    }
  ...
  public Date getPingbiaodate() {
    return pingbiaodate;
  }

  public void setPingbiaodate(Date pingbiaodate) {
    this.pingbiaodate = pingbiaodate;
  }

  public ZcEbChangdi getChangdi2() {
    return changdi2;
  }

  public void setChangdi2(ZcEbChangdi changdi2) {
    this.changdi2 = changdi2;
  }
