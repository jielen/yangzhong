...
public class ZcEbEntrust extends ZcBaseBill implements Serializable {
   ...
   * 表明当前对象是否处于补抽预算模式
   */
  private boolean isBuChongYuSuan = false;
  ...
  public boolean isBuChongYuSuan() {
    return isBuChongYuSuan;
  }

  public void setBuChongYuSuan(boolean isBuChongYuSuan) {
    this.isBuChongYuSuan = isBuChongYuSuan;
  }
}
