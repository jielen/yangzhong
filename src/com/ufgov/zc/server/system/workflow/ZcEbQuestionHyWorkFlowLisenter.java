 ...
 */
public class ZcEbQuestionHyWorkFlowLisenter extends TaskAdapter {
  ...
  public void afterExecution(WorkflowContext context) throws WorkflowException {
    ...
    zcEbBaseServiceDao.updateObjectList("com.ufgov.zc.server.zc.dao.ZcEbQuestionMapper.updateHyDate", objLst);
