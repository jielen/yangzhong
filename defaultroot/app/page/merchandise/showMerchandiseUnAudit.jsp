...
$().ready(function() {
	...
	$goodsForm.validate({
		...
		submitHandler: function(form) {
			...
			form.action = "/GB/portal/page/merchandise/UpdateMerchandise.do?index=unaudit";
			form.submit();
			alert("保存成功！");
		}
	});
...
<body class="input goods">
	<div class="bar">
		<input type="button" class="formButton" onclick="location.href='/GB/portal/page/merchandise/MerchandiseUnAuditList.do'" value="返 回" />
	</div>
	<div class="bar" align="center">
		<font color="blue" size="3"><B>退回商品编辑页面</B></font>
	</div>
	<div class="body">
		<form id="goodsForm" action="/GB/portal/page/merchandise/UpdateMerchandise.do?index=unaudit" method="post" enctype="multipart/form-data">
				...
				<tr>
					...
					<td>
						<% if (zcBMerchandise.getZcMerCode()!= null){ %>
							...
							<input type="text" id="zcBMerchandise.zcMerCode" name="zcBMerchandise.zcMerCode" value="<%=beanWriteValue.toString() %>"  readonly="readonly"  title="若留空则由系统自动生成" />
						<% } else{%>
							<input type="text" id="zcBMerchandise.zcMerCode" name="zcBMerchandise.zcMerCode" value=""  readonly="readonly"  title="若留空则由系统自动生成" />
						<%} %>
					</td>
				</tr>
				<tr>
					...
					<td>
						<% if (zcBMerchandise.getZcMerName()!= null){ %>
							...
							<input type="text" name="zcBMerchandise.zcMerName" class="formText {required: true, messages: {required: '请填写商品名称!'}}" value="<%=beanWriteValue.toString() %>" />
				...
				<tr>
					...
					<td>
						<% if (zcBMerchandise.getZcMerSpec()!= null){ %>
							...
							<input type="text" name="zcBMerchandise.zcMerSpec" class="formText {required: true, messages: {required: '请填写商品型号!'}}" value="<%=beanWriteValue.toString() %>" />
							<label class="requireField">*</label>
						<% } else{%>
				...
				<tr id="zcDiyuDaima">
					...
					<td>
						<% if ( zcBMerchandise.getZcDiyuDaima()!= null && zcBMerchandise.getZcDiyuDaima().equals("850001") ){%>
							<label><input type="radio" name="zcBMerchandise.zcDiyuDaima" value="850000" />省内</label>
							<label><input type="radio" name="zcBMerchandise.zcDiyuDaima" value="850001" checked="checked" />省外</label>
						<%} else{%>
				...
				<tr id="zcYear">
					...
					<td>
						<% if (zcBMerchandise.getZcYear()!= null ){ %>
							...
							<input type="text" id="zcBMerchandise.zcYear" name="zcBMerchandise.zcYear" class="formText {required: true, messages: {required: '请填写财政年度!'}}" value="<%=beanWriteValue.toString() %>" title="前台不会显示，仅供后台使用"  onblur="checkND()"/>
							<label class="requireField">*</label>
						<% } else{%>
				...
				<tr id="zcMerTax">
					...
					<td>
						<% if (zcBMerchandise.getZcMerTax()!= null ){ %>
							...
							<input type="text" id="zcMerTax" name="zcBMerchandise.zcMerTax" class="formText {required: true, min: 0, messages: {required: '请填写市场价（元）!', min: '市场价（元）不允许小于0!'}}" value="<%=beanWriteValue.toString() %>" />
							<label class="requireField">*</label>
						<% } else{%>
							<input type="text" id="zcMerTax" name="zcBMerchandise.zcMerTax" class="formText {required: true, min: 0, messages: {required: '请填写市场价（元）!', min: '市场价（元）不允许小于0!'}}" value="" />
							<label class="requireField">*</label>
						<%} %>
					</td>
				</tr>
				<tr id="zcMerMPrice">
					...
					<td>
						<% if (zcBMerchandise.getZcMerMPrice()!= null ){ %>
							...
							<input type="text" id="zcBMerchandise.zcMerMPrice" name="zcBMerchandise.zcMerMPrice" class="formText {required: true, min: 0, messages: {required: '请填写协议价（元）!', min: '协议价（元）不允许小于0!'}}" value="<%=beanWriteValue.toString() %>" />
							<label class="requireField">*</label>
						<% } else{%>
							<input type="text" id="zcBMerchandise.zcMerMPrice" name="zcBMerchandise.zcMerMPrice" class="formText {required: true, min: 0, messages: {required: '请填写协议价（元）!', min: '协议价（元）不允许小于0!'}}" value="" />
							<label class="requireField">*</label>
						<%} %>
					</td>
				</tr>
				<tr id="zcMerUnit">
					...
					<td>
						<% if (zcBMerchandise.getZcMerUnit()!= null ){ %>
							...
							<input type="text" id="zcMerUnit" name="zcBMerchandise.zcMerUnit" value="<%=beanWriteValue.toString() %>"  class="formText {required: true, messages: {required: '请填写计量单位!'}}" />
							<label class="requireField">*</label>
						<% } else{%>
				...
				<tr>
					...
					<td>
						<% if (zcBMerchandise.getZcIsShared()!= null && zcBMerchandise.getZcIsShared().equals("N")){ %>
							<label><input type="radio" name="zcBMerchandise.zcIsShared" value="Y" />是</label>
							<label><input type="radio" name="zcBMerchandise.zcIsShared" value="N" checked="checked" />否</label>
						<% } else{%>
				...
				<tr>
					...
					<td>
						<% if (zcBMerchandise.getZcMerIsZzcx()!= null && zcBMerchandise.getZcMerIsZzcx().equals("N")){ %>
							<label><input type="radio" name="zcBMerchandise.zcMerIsZzcx" value="Y" />是</label>
							<label><input type="radio" name="zcBMerchandise.zcMerIsZzcx" value="N" checked="checked" />否</label>
						<% } else{%>
				...
				<tr>
					...
					<td>
						<% if (zcBMerchandise.getZcMerIsLshb()!= null && zcBMerchandise.getZcMerIsLshb().equals("N")){ %>
							<label><input type="radio" name="zcBMerchandise.zcMerIsLshb" value="Y" />是</label>
							<label><input type="radio" name="zcBMerchandise.zcMerIsLshb" value="N" checked="checked" />否</label>
						<% } else {%>
				...
				<tr>
					...
					<td>
						<% if (zcBMerchandise.getZcIsJnjs()!= null && zcBMerchandise.getZcIsJnjs().equals("N")){ %>
							<label><input type="radio" name="zcBMerchandise.zcIsJnjs" value="Y" />是</label>
							<label><input type="radio" name="zcBMerchandise.zcIsJnjs" value="N" checked="checked" />否</label>
						<% } else {%>
											...
											<li>
												<div class="goodsImageBox">
													...
													<div class="goodsImageOperate">
														<a class="left" href="javascript: void(0);" title="左移" hidefocus="true"></a>
														<a class="right" href="javascript: void(0);" title="右移" hidefocus="true"></a>
														<a class="delete" href="javascript: void(0);" title="删除" hidefocus="true">
				...
				<logic:notEmpty name="spForm" property="zcCatalogueProp">
					<logic:iterate id="sp"  name="spForm" property="zcCatalogueProp" type="com.ufgov.zc.common.zc.model.ZcBMerCatalogueProp" scope="request">
						<tr id="CatalogueProp">
							...
							<td>
								<input type="text" id="zcBCatalogueProp.<bean:write name="sp" property="zcCataPropEnName"/>" name="zcBCatalogueProp.<bean:write name="sp" property="zcCataPropEnName"/>" value="<bean:write name="sp" property="zcCataPropValue"/>" class="formText {required: true, messages: {required: '请填写<bean:write name="sp" property="zcCataPropChName"/>!'}}" />
								<label class="requireField">*</label>
							</td>
						</tr>
					</logic:iterate>
					...
					<td>
						<table id="agencyScoreTable" class="inputTable goodsSpecificationTable">
							...
							<tr class="hidden {scoreindex: -1}">
								<td  align="center">
									<select id="zcEbSupplier.supplierCode" name="zcEbSupplier[-1].supplierCode" class="formText {required: true, messages: {required: '请选择供应商!'}}" disabled size="1">
										<option value="">请选择...</option>
										<logic:notEmpty name="spForm">
								...
								<td  align="center">
									<input id="zcEbSupplier.lower" type="text" name="zcEbSupplier[-1].lower" class="formText {required: true, min: 0, messages: {required: '请填写折扣下限!', min: '折扣下限不允许小于0!'}}" value=""  style="width: 50px;" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" disabled/>
								</td>
								<td  align="center">
									<input id="zcEbSupplier.upper" type="text" name="zcEbSupplier[-1].upper" class="formText {required: true, min: 0, messages: {required: '请填写折扣上限!', min: '折扣上限不允许小于0!'}}" value=""  style="width: 50px;" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" disabled/>
								</td>
								<td  align="center">
									<input id="zcEbSupplier.discount" type="text" name="zcEbSupplier[-1].discount" class="formText {required: true, min: 0, max: 100, messages: {required: '请填写折扣率!', min: '折扣率不允许小于0!', max: '折扣率不允许大于100!'}}" value=""  style="width: 50px;" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" disabled/>%
								</td>
								<td  align="center">
