...
%>
<%
  String spSearchUrl = "/GB/portal/page/merchandise/SearchMerChandiseByPropertyForAgent.do"; 
...
function spSearch() {
	...
	window.location.href("/GB/portal/page/merchandise/SearchMerChandiseByPropertyForAgent.do?keyWords="+keyWords.Trim()+"&youhl1="+Youhl1.Trim()+"&youhl2="+Youhl2.Trim()+"&xyPrice1="+XyPrice1.Trim()+"&xyPrice2="+XyPrice2.Trim());
}
	...
	<!-- 
		...
		<div class="bar" align="center">
			<font color="blue" size="3"><B>正式库商品信息列表</B></font>
		</div>
		<div class="listBar">
				&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<logic:notEmpty name="spForm">
						<logic:iterate id="sp" name="spForm"  property="merchandiseList" type="com.ufgov.zc.common.zc.model.ZcBMerchandise" scope="request">
							<tr>
								...
								<td>
									<a href="/GB/portal/page/merchandise/SelectMerchandiseForAgent.do?id=<bean:write name="sp" property="zcMerCode" />"
										title="编辑">[编辑]</a>
								</td>
							</tr>
						</logic:iterate>
