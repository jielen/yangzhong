...
$().ready(function() {
	...
	$goodsForm.validate({
		...
		submitHandler: function(form) {
			...
			form.action = "/GB/portal/page/merchandise/UpdateMerchandiseForAgent.do";
			form.submit();
			alert("保存成功！");
		}
	});
...
<body class="input goods">
	<div class="bar">
		<input type="button" class="formButton" onclick="location.href='/GB/portal/page/merchandise/MerchandiseListForAgent.do'" value="返 回" />
	</div>
	<div class="bar" align="center">
		<font color="blue" size="3"><B>正式库商品编辑页面</B></font>
	</div>
	<div class="body">
		<form id="goodsForm" action="/GB/portal/page/merchandise/UpdateMerchandiseForAgent.do" method="post" enctype="multipart/form-data">
