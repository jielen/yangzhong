			...
			<table class="login" width="100%" height="100%" cellspacing="0" cellpadding="0" align="center" border="0">
				<tr><td>
					...
					<table width="1000" height="600" cellspacing="0" cellpadding="0" align="center" valign="middle" border="0" background="/portal/resources/logindantu.jpg">
						...
						<tr><td height="17" width="405"></td>
							<td width="76"><input id="userTxt" name="username" type="text" value="" size="15" style="height:15;width:76;border:0;" onkeypress="moveFocus()"></td>
							<td rowspan="3" width="28">&nbsp;</td>
							<td rowspan="3" width="40" style="cursor:hand" onclick='login(fLogin);'>&nbsp;</td>
							<td rowspan="3">&nbsp;</td>
						</tr>
						<tr><td height="18">&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr><td height="18">&nbsp;</td>
							<td><input id="passwordTxt" name="password" type="password" value="" size="15" style="height:15;width:76;border:0;"  onkeypress="enterLogin()"></td>
						</tr>
