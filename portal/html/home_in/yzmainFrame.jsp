...
<%
	...
	LicenseManager licenseManager = (LicenseManager)ApplusContext.getBean("licenseManager");
  	...
  	String pageId = request.getParameter("pageId");//显示特定用户组
  	if(pageId == null) pageId = "";
  	boolean showFuncLink = true;
...
<html>
	...
	<%} %>
	<!--
	<embed id="bgsound" loop="0" autostart="false" style="display:none" src="/portal/resources/notify.wav"></embed>
	-->
</body>
</html>
		...
		Ext.Ajax.request({
			...
			success: function(response){
				...
				if(textArr.length > 0){
					...
					Ext.ufgovW.QuickTips.close();
				}
				setTimeout(getMessageFromServer,1000*300);
			}
		});
	}
