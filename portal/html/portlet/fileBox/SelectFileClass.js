ufgov.portal.portlet.SelectFileClass = function(){
	
};
Ext.extend(ufgov.portal.portlet.SelectFileClass, ufgov.portal.Base, {
	pageInit: function(){
		this.createMainFrame();
	},
	createMainFrame: function(){
		var sendFileBox = this.getFileClass('sendFile', '发文公文箱', '01', userId);
		var receiveFileBox = this.getFileClass('receiveFile', '收文公文箱', '02', userId);
		var otherFileBox = this.getFileClass('otherFile', '其他公文箱', '03', userId);
		new Ext.Viewport({
	    	layout:'border',
	        items:[{ 
                region: 'west',
...
Ext.onReady(function(){
	Ext.QuickTips.init();
	var SelectFileClass = new ufgov.portal.portlet.SelectFileClass();
	SelectFileClass.pageInit();
});