 ...
 * 公文箱频道
 */
ufgov.portal.portlet.FileBoxPortlet = function(){

};
Ext.extend(ufgov.portal.portlet.FileBoxPortlet, ufgov.portal.Base, {
    panel: null,
    portletId: 'fileBox',
    pageId: '',
    showStyleNum: 1,
    ...
    passParam: function(jsonParam){
        ...
        this.panel = new Ext.Panel({
            ...
            tools: [{
                ...
                handler: function(e, target, panel){
                    window.open("portletDispatcher.action?function=fileBox", "new", "left=0px,top=0px,width=" + (screen.availWidth - 10) + ",height=" + (screen.availHeight) + ",menubar=no,scrollbars=no,status=no,toolbar=no,resizable=no");
                }
            }],
        ...
        // grid双击事件
        fileBoxPanel.on("rowclick", function(grid){
