 ...
 */
ufgov.portal.portlet.EducationOnLine = Ext.extend(ufgov.portal.Base, {
	panel : null,
	gridPart : null,
	gridDownApp : null,
	pgPletId : 'educationOnLine',
	pageId : '',
	portletTitle : '在线视频',
	winMore : null,
	winDetail : null,
...
*/        
		...
		pThis.gridPart.on('cellclick', function(grid,r,c,e) {
			...
			ufgov.portal.portlet.Download.execDownload(record.get('fileId'), record.get("fileName"));
		})				
...
ufgov.portal.portlet.EducationOnLine.execDownload=function(fileId, fileName) {
 	var formObj = document.createElement("form");
    var fileIdObj = document.createElement("input");
    fileIdObj.name = 'fileid';
    fileIdObj.type = 'text';
    fileIdObj.value =fileId;
    var fileNameObj = document.createElement("input");
    fileNameObj.name = 'filename';
    fileNameObj.type = 'text';
    fileNameObj.value = fileName;
        
    formObj.action = path + '/html/portlet/download/online.jsp';
    formObj.target = '_blank';
    document.documentElement.appendChild(formObj);
    formObj.appendChild(fileIdObj);
    formObj.appendChild(fileNameObj);
    formObj.submit();
}
